...
export default function SplitCard({
  ...
  return (
    <Card className="relative flex flex-col items-center justify-end w-[588px] h-[632px] px-[78px] py-[60px] bg-white border border-primary-200 shadow-lg overflow-hidden">
      {/* 아이콘 아래쪽 사각형 배경 */}
